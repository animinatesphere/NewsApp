      ...
      <div>
        ...
        <div className="homepage">
          ...
          <section className="about">
            <h2>About NewsApp</h2>
            <p>
              NewsApp delivers real-time news updates, covering politics,
              sports, business, entertainment, and technology. Our AI-powered
              algorithm ensures you get the most relevant stories tailored to
              your interests.
            </p>
          ...
          <section className="how-it-works">
            ...
            <div className="steps">
              ...
              <div className="step">
                ...
                <p>
                  Subscribe to get notifications on breaking news that matters
                  to you.
                </p>
              </div>
            </div>
